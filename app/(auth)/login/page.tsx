    ...
    <div className="min-h-screen bg-draft-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-draft-green rounded-2xl mb-4">
            <span className="text-draft-black font-bold text-4xl">D</span>
          </div>
